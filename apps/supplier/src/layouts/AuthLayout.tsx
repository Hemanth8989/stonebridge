  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="mb-8 flex flex-col items-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">Supplier Portal</p>
      </div>
      
      <div className="w-full max-w-md">
        {/* We can put the outlet here if we have real auth routes, but for now just render the placeholder login directly inside if we are at /login, or always */}
        <Card>
          <CardHeader>
